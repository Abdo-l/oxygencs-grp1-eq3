...
class App:
    ...
    def __init__(self):
        ...
        self.t_max = os.getenv(temp_conf['T_MAX'])  # Configurez votre température maximale ici
        self.t_min = os.getenv(temp_conf['T_MIN'])  # Configurez votre température minimale ici
